        ...
        @ApiResponse(
                ...
                content = @Content(
                        ...
                        examples = {
                                @ExampleObject(
                                        name = "200 - 예치금 결제 성공",
                                        description = "정상적으로 예치금에 금액을 결제하는데 성공한 경우의 응답 예시입니다.",
                                        value = """
                                                    {
                                                        "status": 200,
                                                        "message": "success",
                                                        "data": {
                                                            "userCode": "019b0dce-d02f-770e-b948-e90b3d27a5c8",
                                                            "depositCode": "019b0dca-9d79-767e-9ee2-4f67edac3efc",
                                                            "amount": 100000,
        ...
        @ApiResponse(
                ...
                content = @Content(
                        ...
                        examples = {
                                @ExampleObject(
                                        name = "404 - 예치금 계좌 미존재",
                                        description = "결제하려는 사용자의 예치금 계좌가 존재하지 않을 경우의 응답 예시입니다.",
                                        value = """
                                                    {
                                                        "status": 404,
        ...
        @ApiResponse(
                ...
                content = @Content(
                        ...
                        examples = {
                                @ExampleObject(
                                        name = "409 - 거래 요청 중복",
                                        description = "ReferenceCode 중복으로 이미 처리된 결제 요청이라고 판단되는 경우의 응답 예시입니다.",
                                        value = """
                                                    {
                                                        "status": 409,
        ...
        @ApiResponse(
                ...
                content = @Content(
                        ...
                        examples = {
                                ...
                                @ExampleObject(
                                        name = "422 - 계좌 잔액 부족",
                                        description = "결제 시도 시 계좌의 잔액이 부족한 경우의 응답 예시입니다.",
                                        value = """
                                                    {
                                                        "status": 422,
...
public @interface PaymentDepositApiResponse {
}
