...
@ApiResponses({
        @ApiResponse(
                ...
                content = @Content(
                        ...
                        examples = {
                                @ExampleObject(
                                        name = "200 - 예치금 충전 성공",
                                        description = "정상적으로 예치금에 금액을 충전하는데 성공한 경우의 응답 예시입니다.",
                                        value = """
                                                    {
                                                        "status": 200,
                                                        "message": "success",
                                                        "data": {
                                                            "userCode": "019b0c7d-ae05-719f-8240-76843c29b5b9",
                                                            "depositCode": "019b0c74-f42b-7a42-aa61-631b814cc01a",
                                                            "amount": 100000,
                                                            "balanceBefore": 0,
                                                            "balanceAfter": 100000,
                                                            "historyType": "CHARGE",
                                                            "transactionStatus": "COMPLETED",
                                                            "referenceCode": "019b0c53-3395-7368-aac8-7bdddab0078e",
        ...
        @ApiResponse(
                ...
                content = @Content(
                        ...
                        examples = {
                                @ExampleObject(
                                        name = "404 - 예치금 계좌 미존재",
                                        description = "충전하려는 사용자의 예치금 계좌가 존재하지 않을 경우의 응답 예시입니다.",
                                        value = """
                                                    {
                                                        "status": 404,
        ...
        @ApiResponse(
                ...
                content = @Content(
                        ...
                        examples = {
                                @ExampleObject(
                                        name = "409 - 거래 요청 중복",
                                        description = "ReferenceCode 중복으로 이미 처리된 거래요청이라고 판단되는 경우의 응답 예시입니다.",
                                        value = """
                                                    {
                                                        "status": 409,
        ...
        @ApiResponse(
                responseCode ="422" ,
                description = "비활성 상태인 입금 계좌를 조작 할 수 없습니다.",
                content = @Content(
                        mediaType = "application/json",
                        schema = @Schema(implementation = BaseResponse.class),
                        examples = {
...
public @interface ChargeDepositApiResponse {
}
