        ...
        @ApiResponse(
                ...
                content = @Content(
                        ...
                        examples = {
                                @ExampleObject(
                                        name = "200 - 예치금 출금 성공",
                                        description = "정상적으로 예치금에 금액을 출금하는데 성공한 경우의 응답 예시입니다.",
                                        value = """
                                                    {
                                                        "status": 200,
                                                        "message": "success",
                                                        "data": {
                                                            "userCode": "019b0dd6-6bc8-7db4-86b3-7c2672f0c24e",
                                                            "depositCode": "019b0dd5-fbe1-760e-bdbb-b552d94e66a5",
                                                            "amount": 100000,
        ...
        @ApiResponse(
                ...
                content = @Content(
                        ...
                        examples = {
                                @ExampleObject(
                                        name = "404 - 예치금 계좌 미존재",
                                        description = "출금하려는 사용자의 예치금 계좌가 존재하지 않을 경우의 응답 예시입니다.",
                                        value = """
                                                    {
                                                        "status": 404,
        ...
        @ApiResponse(
                ...
                content = @Content(
                        ...
                        examples = {
                                @ExampleObject(
                                        name = "409 - 거래 요청 중복",
                                        description = "ReferenceCode 중복으로 이미 처리된 출금 요청이라고 판단되는 경우의 응답 예시입니다.",
                                        value = """
                                                    {
                                                        "status": 409,
        ...
        @ApiResponse(
                ...
                content = @Content(
                        ...
                        examples = {
                                ...
                                @ExampleObject(
                                        name = "422 - 계좌 잔액 부족",
                                        description = "출금 시도 시 계좌의 잔액이 부족한 경우의 응답 예시입니다.",
                                        value = """
                                                    {
                                                        "status": 422,
...
public @interface WithdrawDepositApiResponse {
}
